...
object AppColors {
    ...
    /**
     * Cards "Próxima coleta" e "Sua jornada" — gradiente horizontal.
     *
     * É uma função porque o gradiente linear do Compose precisa conhecer a
     * largura do componente para terminar exatamente na borda direita.
     */
    ...
    /** Gradiente do avatar da posição [index], com módulo pela paleta. */

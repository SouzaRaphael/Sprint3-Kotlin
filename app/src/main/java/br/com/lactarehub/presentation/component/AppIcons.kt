...
object AppIcons {
    ...
    val Author: ImageVector = Icons.Outlined.Person
    ...
    val GiftFilled: ImageVector = Icons.Filled.CardGiftcard
    val EventAvailable: ImageVector = Icons.Outlined.EventAvailable
    val Route: ImageVector = Icons.Outlined.Route
    val Rocket: ImageVector = Icons.Outlined.RocketLaunch
    val Fire: ImageVector = Icons.Outlined.LocalFireDepartment
    ...
    val DropOutlined: ImageVector = Icons.Outlined.WaterDrop
    val Route2: ImageVector = Icons.Filled.TurnRight
    val Call: ImageVector = Icons.Outlined.Call
    val Place: ImageVector = Icons.Outlined.Place
    val NearMe: ImageVector = Icons.Outlined.NearMe
    ...
    val BadgeHeart: ImageVector = Icons.Outlined.FavoriteBorder
    val BadgeLeaf: ImageVector = Icons.Outlined.Eco
    ...
    val Mailbox: ImageVector = Icons.Outlined.MarkunreadMailbox
    val Baby: ImageVector = Icons.Outlined.ChildCare
    val Breastfeeding: ImageVector = Icons.Outlined.VolunteerActivism
    ...
    val Time: ImageVector = Icons.Filled.AccessTime
    val Shipping: ImageVector = Icons.Outlined.LocalShipping
    val Note: ImageVector = Icons.Outlined.StickyNote2
}
